...
const char *host = "192.168.43.124";   //https://circuits4you.com website or IP address of server
...
void loop() {
 ...
 Serial.print(tinggi_air); Serial.print(" CM"); 
  ...
  http.begin("http://192.168.43.124/tinggisungai/post.php");              //Specify request destination
